<template>
  <div :class="$style['show-body']">
    <a href="#" :class="[$style.button, $style['button-bird']]">
      <div :class="$style['button-wrapper']">
        <span :class="$style['button-text']">ENTRY</span>
      </div>
      <div :class="$style.birdBox">
        <div :class="[$style.bird, $style.wakeup]">
          <div :class="$style['bird-face']"></div>
        </div>
        <div :class="[$style.bird, $style.wakeup]">
          <div :class="$style['bird-face']"></div>
        </div>
        <div :class="$style.bird">
          <div :class="$style['bird-face']"></div>
        </div>
      </div>
    </a>
...
.button-bird .button-wrapper::before,
.button-bird .button-wrapper::after {
  content: "";
  position: absolute;
  bottom: 0;
  width: 130px;
...
.button:hover .wakeup .bird-face {
  top: 20px;
}
.button:hover .wakeup .bird-face::before,
.button:hover .wakeup .bird-face::after {
  animation: eye 5s linear infinite;
}

.button:hover .wakeup:nth-child(2) .bird-face::before,
.button:hover .wakeup:nth-child(2) .bird-face::after {
